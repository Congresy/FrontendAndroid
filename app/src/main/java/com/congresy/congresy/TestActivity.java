...
public class TestActivity extends AppCompatActivity {
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (!etAmount.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(TestActivity.this, "Please enter a valid amount.", Toast.LENGTH_SHORT).show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, send_payment_details,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if(response.contains("redirect:checkouts/"))
                        {
                            Toast.makeText(TestActivity.this, "Transaction successful", Toast.LENGTH_LONG).show();
                        }
                        else Toast.makeText(TestActivity.this, "Transaction failed", Toast.LENGTH_LONG).show();
    ...
    private class HttpRequest extends AsyncTask {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progress = new ProgressDialog(TestActivity.this, android.R.style.Theme_DeviceDefault_Dialog);
            ...
            client.get(get_token, new HttpResponseCallback() {
                ...
                public void success(final String responseBody) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(TestActivity.this, "Successfully got token", Toast.LENGTH_SHORT).show();
                ...
                public void failure(Exception exception) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(TestActivity.this, "Failed to get token: " + ex.toString(), Toast.LENGTH_LONG).show();
                        }
                    });
                }
            });
